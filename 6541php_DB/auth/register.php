        ...
        <div class="login-form">
            ...
            <form action="register_script.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="email" value="test@gmail.com" id="email"
            ...
            <p style="text-align: center; margin-top: 20px;">Already have an Account ? <a href="login.php">Sign In</a>
            </p>
        </div>
    </div>
</body>
