...
if (!isset($_SESSION['username'])) {
    header("Location: ../HW10_015/loginCrud/login.php");
    exit();
}
                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form action="edit_script.php" method="post" class="requires-validation" novalidate>
                            ...
                            <div class="col-md-12">
                                <input class="form-control" type="text" name="reservedBy" value='<?php echo $reservation['reservedBy']; ?>' placeholder="ชื่อผู้เข้าจอง"
                                    required>
                                <div class="invalid-feedback">โปรดใส่ชื่อผู้เข้าจองก่อนกดยืนยัน</div>
                            </div>

                            <div class="col-md-12">
                                <input class="form-control" type="email" value="<?php echo $reservation['email']; ?>" name="email" placeholder="Email ผู้เข้าจอง"
                                    required>
                                <div class="invalid-feedback">โปรดใส่อีเมลล์ผู้เข้าจองก่อนกดยืนยัน</div>
                            </div>

                            <div class="col-md-12 mt-3">
                                <input class="form-control" type="number" name="dayAmount" value="<?php echo $reservation['dayAmount'];?>"
                                    placeholder="โปรดใส่จำนวนวันที่เข้าพัก" required>
                                <div class="invalid-feedback">โปรดใส่จำนวนวันที่เข้าพักก่อนกดยืนยัน</div>
                            </div>

                            <div class="col-md-12 mt-3">
                                <input class="form-control" type="number" name="peopleAmount" value="<?php echo $reservation['peopleAmount'];?>"
                            ...
                            <div class="col-md-12">
                                <select name="roomType" class="form-select mt-3" required >
                                    <option selected value="<?php $reservation['roomType']?>"><?php echo $reservation['roomType'] == 'normal' ? 'ห้องปกติ' : ($reservation['roomType'] == 'deluxe' ? 'ห้อง Deluxe' : 'ห้อง First Class' ) ;?></option>
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <input type="radio" class="btn-check" <?php echo $reservation['member'] == 0 ? '' : 'checked'; ?> name="member" id="true" value="true"
                                    autocomplete="off" required>
                                <label class="btn btn-sm btn-outline-secondary" for="true">เป็นสมาชิก</label>

                                <input type="radio" class="btn-check" name="member" <?php echo $reservation['member'] == 1 ? '' : 'checked'; ?> value="false" id="false"
                                    autocomplete="off" required>
